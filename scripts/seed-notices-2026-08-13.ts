...
const DRAFTS: Draft[] = [
  ...
  },
  {
    ...
    date: '2026-08-13',
    kind: '신규',
    title: '이제 상대가 곧 상금입니다 — 바운티 헌터 · 미스터리 바운티',
    summary: '이제 오래 버티는 것만이 답이 아닙니다. 상대를 떨어뜨리면 그 사람에게 걸린 '
      + '바운티가 그대로 내 것이 됩니다. 금액이 다 보이는 모드와, 잡아 봐야 아는 모드 '
      + '두 가지가 열립니다.',
    sections: [
      {
        ...
        paras: [
          ...
          '이제 <b>사람마다 바운티가 걸립니다.</b> 그 사람을 떨어뜨린 사람이 그 바운티를 '
            + '가져갑니다. 세 번째 판에 털려 나가도, 그 전에 두 명을 잡았다면 '
            + '주머니는 채우고 나갑니다.',
        ],
        bullets: [
          '상대를 탈락시키면 그 사람 바운티를 <b>전액</b> 가져갑니다. 절반도, 나눠 갖기도 아닙니다.',
          '내 바운티는 <b>끝까지 그대로입니다.</b> 잡을수록 내가 비싸지는 일은 없습니다 — '
            + '사냥꾼이 사냥감이 되지 않습니다.',
          '아무도 못 잡고 우승해도 괜찮습니다. <b>내 바운티는 우승하면 내가 회수합니다.</b>',
      ...
      },
      {
        ...
        paras: [
          '모든 사람 위에 <b>금빛 명찰</b>이 붙고 거기에 바운티가 적힙니다. 저 사람을 '
            + '잡으면 얼마인지 처음부터 알고 앉는 판입니다.',
          '그래서 누구를 노릴지 고를 수 있습니다. 스택이 큰 사람을 피해 갈 수도, '
            + '바운티가 큰 사람을 향해 밀어 넣을 수도 있습니다.',
        ],
        bullets: [
          '바운티는 전원 같고, 대회가 끝날 때까지 바뀌지 않습니다.',
      ...
      },
      {
        ...
        paras: [
          '이 모드에서는 <b>명찰이 아예 붙지 않습니다.</b> 저 사람 바운티가 얼마인지 '
            + '아무도 모릅니다 — 본인조차 모릅니다.',
          '누군가를 떨어뜨리면 테이블 한가운데 <b>전광판</b>이 올라옵니다. 숫자가 '
            + '정신없이 굴러가다가 — 딱 멈춥니다. 그 한순간이 그 사람 바운티가 '
            + '공개되는 유일한 자리입니다.',
          '첫 판에 터진 숏스택이 잭팟을 들고 있었을 수도 있습니다. 반대로 끝까지 '
            + '살아남은 칩 리더가 알고 보니 가장 싼 바운티였을 수도 있습니다.',
        ],
        bullets: [
          '바운티는 <b>대회마다 새로 뽑습니다.</b> 같은 인원이라도 어제와 다릅니다 — 외울 수 없습니다.',
          '한 판에 여러 명이 터지면 <b>한 사람씩 차례로</b> 전광판이 돕니다.',
          '내 바운티는 우승하면 내가 받습니다 — 끝까지 아무도 나를 잡지 못하면 그때 열립니다.',
          '0P짜리는 없습니다. 다만 편차는 큽니다 — 아래 표를 보세요.',
        ],
      },
      {
        heading: '얼마까지 나올 수 있나',
        paras: [
          '한 사람 바운티가 전체 바운티의 몇 %까지 갈 수 있는지 정해 두었습니다. '
            + '인원이 많아지면 한 사람 몫의 평균이 작아지니 범위도 같이 내려갑니다.',
        ],
        table: { head: ['참가 인원', '평균', '나올 수 있는 범위'], rows: ENV_ROWS },
        bullets: [
          `${EX_N}명이면 한 사람 바운티가 전체 바운티의 `
            + `<b>${EX_RANGE.lo}% ~ ${EX_RANGE.hi}%</b> 사이에서 나옵니다.`,
          '상한을 둔 이유가 있습니다 — 한 사람이 다 가져가 버리면 나머지 바운티가 '
      ...
      },
      {
        ...
        paras: [
          '바운티가 걸린 대회에서는 탈락이 확정되는 순간 <b>총성이 세 번 울리고 프로필에 '
            + '총자국이 박힙니다.</b> 바운티가 걸린 판이니 나가는 자리도 그만한 대접을 '
            + '해 드립니다.',
          '카드와 칩 정산이 전부 끝난 뒤에 시작하니 결과를 가리지는 않습니다.',
        ],
        bullets: [
          '순서는 [카드 공개 → 칩 이동 → 탈락 연출 → 바운티 공개 → 획득 표시] 입니다.',
      ...
      },
      {
        ...
        bullets: [
          '바운티가 없는 일반 대회에서는 명찰도, 총성도 나오지 않습니다 — '
            + '예전 그대로입니다.',
        ],
      },
      {
