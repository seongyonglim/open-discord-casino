...
window.__ICON = (function(){
  ...
  return {
    ...
    /* 트로피 — 시즌 랭킹을 가리킨다. 잔 · 손잡이 · 받침 세 조각으로만 그려서
       14px 에서도 뭉개지지 않는다(🏆 는 기기마다 색과 모양이 다르다). */
    trophy: ico('M8 4h8v4.5a4 4 0 0 1-8 0zM12 13v3.5M9 20h6M10.5 16.5h3'
      + 'M8 5.5H6.2A2.2 2.2 0 0 0 8 9.6M16 5.5h1.8A2.2 2.2 0 0 1 16 9.6'),
    // 꺾쇠 — "여기 눌러 보면 더 있다" 를 말하는 자리에 쓴다
    chev: ico('M9.5 6.5l5.5 5.5-5.5 5.5'),
...
window.casinoBadge = (function(){
  ...
  function set(el, text){
    ...
    /* 시계는 «초를 셀 때» 만 뜻이 있다. 플랍·턴·리버처럼 숫자가 없는 문구에는
