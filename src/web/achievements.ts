...
/* 아이콘 아래 적는 게임 이름.
   ...
   탭 이름과 다른 짧은 말을 쓴다. 아이콘 칸이 좁아 "홀덤 토너먼트"는 잘리는데, 잘린 이름은
   없느니만 못하다. 어차피 옆에 과제 설명이 붙어 있어 짧아도 헷갈리지 않는다.
   다만 "짧게"가 "무슨 게임인지 모르게"가 되면 안 된다 — 아래 포커 항목을 보라. */
const TYPE_LABEL: Record<string, string> = {
  /* 포커는 "포커 플립"이 게임 이름이다. 한동안 "포커"로만 적었는데, 이 카지노에는
     홀덤도 있어서 그냥 "포커"는 어느 게임인지 가리키지 못한다.
     칸이 좁다는 것이 짧게 쓴 이유였는데 재 보니 들어간다 — 칸 안쪽 54px 에 "포커 플립"이
     43px 이고, 이미 들어가 있는 "지뢰찾기"가 40px 다. */
  HOLDEM: '홀덤', BACCARAT: '바카라', BLACKJACK: '블랙잭', POKER: '포커 플립',
